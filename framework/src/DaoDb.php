...
/////////////////////////////////////////////////
abstract class DaoDb extends DatabaseMask {
...
//                }
	...
	protected function setPager($total,$page,$per) {
		...
		// pages
		$this->pages = ($page>0?ceil($total/$per):1);
	
		// sttart
		$this->start = ( ($page-1) * $per )+1;
	...
	public function getStart() {
		return number_format((double)$this->start);
	}
	...
	public function getEnd() {
		return number_format((double)$this->end);
	}
	...
	public function getTotal() {
		return number_format((double)$this->total);
	}	
	...
	public function getPages() {
		...
		return number_format((double)$this->pages);
	}	
	...
	public function getPage() {
		...
		return number_format((double)$this->page);
	}		
	...
	public function getPer() {
		return number_format((double)$this->per);
	}		
